...
if ( ! planetaryObliterationLoaded )
{
    ...
    function planetaryObliteration()
    {
        ...
        var patchName = 'planetaryObliteration live_game_time_bar.js';
        ...
        if(themesetting === "ON"){  
            loadCSS("coui://ui/mods/com.stuart98.planetaryobliteration/css/planetaryObliteration_time_bar.css");
        }
