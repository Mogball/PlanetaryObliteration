    ...
    function PO() {
        ...
        model.enablePO = function () {
            ...
            var newPersonalities = {
                ...
                'Obliteration Aggressive': {
                    display_name: '!LOC:Obliteration Aggressive',
                    percent_vehicle: 0.45,
                    percent_bot: 0.25,
                    percent_air: 0.2,
                    percent_naval: 0.05,
                ...
                'Obliteration Air': {
                    display_name: '!LOC:Obliteration Air',
                    percent_vehicle: 0.2,
                    percent_bot: 0.2,
                    percent_air: 0.5,
                    percent_naval: 0.05,
                ...
                'Obliteration Balanced': {
                    display_name: '!LOC:Obliteration Balanced',
                    percent_vehicle: 0.3,
                    percent_bot: 0.3,
                    percent_air: 0.3,
                    percent_naval: 0.05,
                ...
                'Obliteration Bot': {
                    display_name: '!LOC:Obliteration Bot',
                ...
                'Obliteration Cautious': {
                    display_name: '!LOC:Obliteration Cautious',
                    percent_vehicle: 0.45,
                    percent_bot: 0.25,
                    percent_air: 0.2,
                    percent_naval: 0.05,
                ...
                'Obliteration Naval': {
                    display_name: '!LOC:Obliteration Naval',
