...
if ( ! POLoaded )
{
    ...
    */
    ...
    function PO()
    {
        ...
        console.log( 'PO start.js' );
        
        /*legion youtube intro
...
console.error('legionYouTubePlayerErrorEvent ' + JSON.stringfy(event));
        ...
        */
        ...
        if(themesetting === "ON") {
            ...
            loadCSS("coui://ui/mods/com.stuart98.po/css/PO_background_logo.css");
            loadCSS("coui://ui/mods/com.stuart98.po/css/PO_start.css");
            $('body').addClass("PO");
        }
    }
