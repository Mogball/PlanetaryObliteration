...
$(document).ready(function () {
    ...
    function BuildSet(params) {
        ...
        self.tabs = ko.observableArray([
            ...
            new BuildTab('vehicleadv', '!LOC:vehicle'),
            new BuildTab('bot', '!LOC:bot'),
            new BuildTab('botadv', '!LOC:bot'),
            new BuildTab('air', '!LOC:air'),
            new BuildTab('airadv', '!LOC:air'),
            ...
            new BuildTab('L_vehicle', '!LOC:vehicle'),
            new BuildTab('L_vehicleadv', '!LOC:vehicle'),
            new BuildTab('L_bot', '!LOC:bot'),
            new BuildTab('L_botadv', '!LOC:bot'),
            new BuildTab('L_air', '!LOC:air'),
            new BuildTab('L_airadv', '!LOC:air'),
            new BuildTab('L_sea', '!LOC:sea'),
            new BuildTab('L_seaadv', '!LOC:sea'),
            new BuildTab('L_orbital', '!LOC:orbital'),
            new BuildTab('L_orbital_structure', 'orbital structure'),
            new BuildTab('L_ammo', '!LOC:ammo', true)
        ]);
